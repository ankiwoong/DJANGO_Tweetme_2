...
.....F..
======================================================================
FAIL: test_tweet_delete_api_view (tweets.tests.TweetTestCase)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "D:\Code\Study\DJANGO_Tweetme_2\tweets\tests.py", line 97, in test_tweet_delete_api_view
    self.assertEqual(response_incorrect_owner.status_code, 403)
AssertionError: 401 != 403

----------------------------------------------------------------------
Ran 8 tests in 8.781s
